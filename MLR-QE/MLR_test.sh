...
java -jar  $RANKLIBDIR/RankLib_old.jar -load  $modelsdir/MLR.model -rank $testFile \
                                       -metric2T MAP -norm zscore -score  $BASEDIR/temp/MLR/Scores 2>&1 | grep WriteNothing
